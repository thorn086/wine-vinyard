...
class AddWine extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            <div className='addwine__style'>
                <h2 className='title__page add__wine'>Add A Wine</h2>
                <NavBar />
                <WineForm onSubmit={this.handleAddWine}>
                    <div className='wine__field'>
                        <WineErr>
                            ...
                            {<ValErr message={this.validateWincat()} />}
                        </WineErr>
                    </div>
                    <div className='wine__field'>
                        <WineErr>
                            <label htmlFor='wine-date-input'>Year</label>
                            <select id='date' name='date-input'  onChange={e => this.handleUpdate(e)}>
                                {
                    ...
                    <div className='wine__field'>
                        <WineErr>
                            ...
                            {<ValErr message={this.validateComp()} />}
                        </WineErr>
                    </div>
                    <div className='wine__field'>
                        <WineErr>
                            ...
                            {<ValErr message={this.validateName()} />}
                    ...
                    <div className='wine__field'>
                        <WineErr>
                            ...
                            { <ValErr message={this.validateContent()} />}
                    ...
                    <div className='wine__field'>
                        <WineErr>
                            ...
                            {<ValErr message={this.validateRate()} />}
                        </WineErr>
                    </div>
